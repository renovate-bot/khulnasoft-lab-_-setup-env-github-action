...
[![GitHub Build Status](https://github.com/khulnasoft-lab/setup-env-github-action/workflows/build/badge.svg)](https://github.com/khulnasoft-lab/setup-env-github-action/actions)
...
jobs:
  test:
    ...
    steps:
      - uses: khulnasoft-lab/setup-env-github-action@develop
```
